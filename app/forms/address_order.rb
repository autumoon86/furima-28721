class AddressOrder
  ...
  def save
    ...
    Address.create!(item_id: item_id, postcode: postcode, prefecture_id: prefecture_id, city: city, block: block, building: building, phone_number: phone_number, exhibition_id: order.id )
  end
end